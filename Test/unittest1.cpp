...
{		
	...
	public:
		...
		TEST_METHOD(Declaration)
		{
			...
			p = new skiff::statements::decleration("x", skiff::types::type_class("Int"));
			...
			p = new skiff::statements::decleration("x", skiff::types::type_class("List", et));
			Assert::AreEqual(p->parse_string(), s->parse_string());
		}
		...
		TEST_METHOD(Bitwise)
		{
			...
			p = new skiff::statements::bitinvert(new skiff::statements::statement("x"));
			Assert::AreEqual(p->parse_string(), s->parse_string());
		}
		...
		TEST_METHOD(BooleanOperations)
		{
			...
			s = skiff::parse_statement("!x");
			p = new skiff::statements::invert(new skiff::statements::statement("x"));
			Assert::AreEqual(p->parse_string(), s->parse_string());
		}
		...
		TEST_METHOD(BasicMath)
		{
			...
			for (char c : basics)
			{
				...
				operands.push(new skiff::statements::statement("x"));
		...
		TEST_METHOD(IfStatement)
		{
			...
			p = new skiff::statements::if_heading(new skiff::statements::statement("x"));
			Assert::AreEqual(p->parse_string(), s->parse_string());
		...
		TEST_METHOD(WhileStatement)
		{
			...
			p = new skiff::statements::while_heading(new skiff::statements::statement("x"));
			Assert::AreEqual(p->parse_string(), s->parse_string());
		...
		TEST_METHOD(ForStatement)
		{
			...
			p = new skiff::statements::for_itterator_heading(
				new skiff::statements::decleration("x", skiff::types::type_class("Int")), 
				new skiff::statements::statement("lst")
			);
			Assert::AreEqual(p->parse_string(), s->parse_string());
		}
		...
		TEST_METHOD(DeclarationModifiers)
		{
			...
			p = new skiff::statements::modifier(skiff::statements::modifier::modifier_type::STATIC,
				new skiff::statements::decleration("test", skiff::types::type_class("String")));
			Assert::AreEqual(p->parse_string(), s->parse_string());
		...
		TEST_METHOD(Annotation)
		{
			...
			vector<skiff::types::function::function_parameter> func_params;
		...
		TEST_METHOD(SwitchMatchHeading)
		{
			...
			p = new skiff::statements::switch_case_heading(new skiff::statements::statement("_"));
			Assert::AreEqual(p->parse_string(), s->parse_string());
		}
	};
}